    ...
    <section className="section_section__ppkch section_collapsible__OYoF5" id="webhooks" data-analytics-scroll-point="true" data-analytics-name="DevPlatformWebhooks">
      <div className="sectionHeader_header__7hACT sectionHeader_alignStart__JDnog">
        <div className="sectionHeader_content__CrL0O">
          <h2 className="sectionHeader_heading__tJvSy">Trigger Notion workflows from anywhere.</h2>
          <p id="connector-anchor-webhooks-subsection-paragraph" className="sectionHeader_subheading__51ZJh">Listen for incoming webhooks from any app, then run workflows with Notion Agents, pages, databases, and external APIs.</p>
          <div className="sectionHeader_ctas__WiORJ">
            <a href="https://developers.notion.com/workers/guides/webhooks" data-analytics-name="dev_platform_webhooks_read_docs" data-analytics-event="click_link" className="semanticTypography_semanticTypography__mWJkv linkText_linkText__527kz linkText_colorVariantPrimary__h6Nef linkText_hasArrow__2BwWV">
      ...
      <div role="img" aria-label="An animation showing external platform webhooks triggering Workers to perform actions in Notion or externally." className="surface surfaceBase surface_surfaceBase__UD3lo slotMachine_slotMachine__USLkJ">
