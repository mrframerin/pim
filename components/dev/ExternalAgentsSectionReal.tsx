    ...
    <section className="section_section__ppkch section_collapsible__OYoF5" id="externalAgents" data-analytics-scroll-point="true" data-analytics-name="DevPlatformExternalAgents">
      <div className="sectionHeader_header__7hACT sectionHeader_alignStart__JDnog">
        <div className="sectionHeader_content__CrL0O">
          ...
          <h2 className="sectionHeader_heading__tJvSy">Bring your favorite agents into Notion.</h2>
          <p className="sectionHeader_subheading__51ZJh">Use external agents like Claude, Cursor, Decagon, or one you’ve built, in a shared interface for your team and agents.</p>
          <div className="sectionHeader_ctas__WiORJ">
            <a href="https://notion.pages.dev.notion.co/351b35e6e67f80128a8cf585188cf668?pvs=105" data-analytics-name="dev_platform_external_agents_join_waitlist" data-analytics-event="click_link" className="semanticTypography_semanticTypography__mWJkv linkText_linkText__527kz linkText_colorVariantPrimary__h6Nef linkText_hasArrow__2BwWV">
              <span className="linkText_linkContent__1nr8w">Join the waitlist</span>
      ...
      <div className="dev_externalAgentCards__VgRTC">
        <article className="surface surfaceBase surface_surfaceBase__UD3lo block_block__NZ57K block_blockIsSurfaceBase__LSebb">
          <div className="block_blockStack__NQPhA">
            <div className="block_blockContent__QSAYI">
              <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ">Mention</h3>
        ...
        <article className="surface surfaceBase surface_surfaceBase__UD3lo block_block__NZ57K block_blockIsSurfaceBase__LSebb">
          <div className="block_blockStack__NQPhA">
            <div className="block_blockContent__QSAYI">
              <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ">Assign</h3>
        ...
        <article className="surface surfaceBase surface_surfaceBase__UD3lo block_block__NZ57K block_blockIsSurfaceBase__LSebb">
          <div className="block_blockStack__NQPhA">
            <div className="block_blockContent__QSAYI">
              <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ">Orchestrate</h3>
        ...
        <article className="surface surfaceBase surface_surfaceBase__UD3lo block_block__NZ57K block_blockIsSurfaceBase__LSebb dev_cardByoAgent__ZA5Gl">
          <div className="block_blockStack__NQPhA block_directionRow__Enme4">
            <div className="block_blockContent__QSAYI">
              <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ">BYO Agent</h3>
              <p className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardBody__E_9cg">Bring your in‑house agents into Notion with the External Agents API. Notion gives them triggers, tools, and permissions so they show up as first‑class collaborators on all the same surfaces.</p>
            </div>
            <div className="block_blockMedia__tgELR block_mediaPlacementRight__6o28Y">
              <div role="img" aria-label="A list of API endpoints that a third-party agent can call to have it behave like a Custom Agent in Notion." className="terminalAsset_terminalAsset__y5TEE">
                <div aria-hidden="true">
                  <pre className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantGlobalCode__nyDlV terminalRichText_terminalRichText__K1SQk" dangerouslySetInnerHTML={{ __html: "<code class=\"terminalRichText_code__rOL9k\"><small>POST</small> /sessions/{id}\r\n<small>POST</small> /sessions/{id}/messages\r\n<small>GET</small>  /sessions/{id}/events\r\n\r\n\r\n\r\n</code>" }} />
                </div>
              </div>
            </div>
          </div>
