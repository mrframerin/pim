            ...
            <div className="block_blockContent__QSAYI dev_platformCardContent__ZrUdw">
              <div>
                <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ dev_platformCardTitle__JXzTM">
                  {c.cli.title}
                  {" "}
                  <span className="badge_badge__4ppzB badge_badgeLight__77Dpi">{c.cli.badge}</span>
                </h3>
                <p className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardBody__E_9cg">{c.cli.body}</p>
              </div>
              <div className="flex flex-row items-center justify-start flex-nowrap inline-auto max-inline-full gap-0 dev_platformCardCta__5XAgR">
                <div className="pt-8 pb-8 ps-16 pe-48 surface surfaceAccent surface_surfaceAccent___PDKt commandCTA_commandContainer__AZ6SG">
                  <div className="commandCTA_commandMask__GCTUb">
                    <input type="text" readOnly={true} aria-label="Install command" spellCheck="false" autoComplete="off" className="commandCTA_command__sAhle" value={c.cli.command} />
                  </div>
              ...
              <a href={c.cli.ctaHref} className="InlineTextLink_inlineLink__oN8YM InlineTextLink_colorTheme__waxe8 InlineTextLink_underlineOnHover__J78xW" target="_self" data-analytics-name="dev_platform_cli_cta" data-analytics-event="click_link" data-analytics-context="platform">
                <span className="InlineTextLink_linkContent__SYI4r">{c.cli.ctaLabel}</span>
          ...
          <div className="block_blockStack__NQPhA">
            <div className="block_blockContent__QSAYI dev_platformCardContent__ZrUdw">
              <div>
                ...
                <p className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardBody__E_9cg">{c.api.body}</p>
              </div>
              <a href={c.api.ctaHref} className="InlineTextLink_inlineLink__oN8YM InlineTextLink_colorTheme__waxe8 InlineTextLink_underlineOnHover__J78xW" target="_self" data-analytics-name="dev_platform_api_cta" data-analytics-event="click_link" data-analytics-context="platform">
                <span className="InlineTextLink_linkContent__SYI4r">{c.api.ctaLabel}</span>
                <span aria-hidden="true" className="Arrow_arrow__oVjWc Arrow_arrowAfter__8m7lp">→</span>
              </a>
            </div>
          </div>
          ...
          <div className="block_blockStack__NQPhA">
            <div className="block_blockContent__QSAYI dev_platformCardContent__ZrUdw">
              <div>
                ...
                <p className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardBody__E_9cg">{c.mcp.body}</p>
              </div>
              <div className="flex flex-row items-center justify-start flex-nowrap inline-auto max-inline-full gap-0 dev_platformCardCta__5XAgR">
                <div className="pt-8 pb-8 ps-16 pe-48 surface surfaceAccent surface_surfaceAccent___PDKt commandCTA_commandContainer__AZ6SG">
                  <div className="commandCTA_commandMask__GCTUb">
                    <input type="text" readOnly={true} aria-label="Install command" spellCheck="false" autoComplete="off" className="commandCTA_command__sAhle" value={c.mcp.command} />
                  </div>
                      ...
                      <ul className="flex flex-col items-stretch justify-start flex-nowrap inline-full gap-0 ps-0 mt-0 mb-0 menuList_menuList__Tn7rd">
                        <li className="menuList_menuListItem___Rmlj">
                          <button type="button" role="menuitemradio" aria-checked="true" className="grid items-center inline-full gap-y-0 menuList_menuListItemButton__QXktT menuList_variantPrimary__XdPVz">
                            <span className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantInteractionMenuListItemLabel___7StL menuList_label__SGqyS">{c.mcp.agentOptions[0]}</span>
                          </button>
                        </li>
                        <li className="menuList_menuListItem___Rmlj">
                          <button type="button" role="menuitemradio" aria-checked="false" className="grid items-center inline-full gap-y-0 menuList_menuListItemButton__QXktT menuList_variantPrimary__XdPVz">
                            <span className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantInteractionMenuListItemLabel___7StL menuList_label__SGqyS">{c.mcp.agentOptions[1]}</span>
                          </button>
                        </li>
                        <li className="menuList_menuListItem___Rmlj">
                          <button type="button" role="menuitemradio" aria-checked="false" className="grid items-center inline-full gap-y-0 menuList_menuListItemButton__QXktT menuList_variantPrimary__XdPVz">
                            <span className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantInteractionMenuListItemLabel___7StL menuList_label__SGqyS">{c.mcp.agentOptions[2]}</span>
                          </button>
                        </li>
                      </ul>
                    </div>
              ...
              <a href={c.mcp.ctaHref} className="InlineTextLink_inlineLink__oN8YM InlineTextLink_colorTheme__waxe8 InlineTextLink_underlineOnHover__J78xW" target="_self" data-analytics-name="dev_platform_mcp_cta" data-analytics-event="click_link" data-analytics-context="platform">
                <span className="InlineTextLink_linkContent__SYI4r">{c.mcp.ctaLabel}</span>
                <span aria-hidden="true" className="Arrow_arrow__oVjWc Arrow_arrowAfter__8m7lp">→</span>
              </a>
            </div>
          </div>
            ...
            <div className="block_blockContent__QSAYI dev_platformCardContent__ZrUdw">
              <div>
                <h3 className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardTitleBlock__8yFeJ dev_platformCardTitle__JXzTM">
                  {c.sdk.title}
                  {" "}
                  <span className="badge_badge__4ppzB badge_badgeLight__77Dpi">{c.sdk.badge}</span>
                </h3>
                <p className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantCardBody__E_9cg">{c.sdk.body}</p>
              </div>
              <a href={c.sdk.ctaHref} className="InlineTextLink_inlineLink__oN8YM InlineTextLink_colorTheme__waxe8 InlineTextLink_underlineOnHover__J78xW" target="_self" data-analytics-name="dev_platform_sdk_cta" data-analytics-event="click_link" data-analytics-context="platform">
                <span className="InlineTextLink_linkContent__SYI4r">{c.sdk.ctaLabel}</span>
                <span aria-hidden="true" className="Arrow_arrow__oVjWc Arrow_arrowAfter__8m7lp">→</span>
              </a>
            </div>
            <div className="block_blockMedia__tgELR dev_cardMedia__rCEVK block_mediaPlacementRight__6o28Y">
              <div role="img" aria-label={c.sdk.codeAriaLabel} className="codeAsset_codeAsset__C1kH7 dev_cardCodeAsset___5NNb">
                <div aria-hidden="true">
                  <pre className="codeSnippet_codeSnippet__Q2VMk language-typescript" style={{ "--code-snippet-white-space": "pre-wrap", "--code-snippet-white-space-lg": "pre", "--code-snippet-overflow": "hidden", "--code-snippet-overflow-lg": "auto" } as CSSProperties} dangerouslySetInnerHTML={{ __html: c.sdk.codeHtml }} />
                </div>
              </div>
            </div>
          </div>
