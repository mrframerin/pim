...
export default function Ticker() {
  return (
    <aside className="ticker_ticker__HGAB1">
      ...
      <span className="semanticTypography_semanticTypography__mWJkv semanticTypography_variantGlobalBody__yYPP0">Syncs, agent tools, and webhook triggers are available in beta.</span>
    </aside>
  );
}
